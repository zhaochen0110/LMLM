...
def main():
    ...
    elif model_args.model_name_or_path=='jhu-clsp/bibert-ende':
    ...
    if data_args.line_by_line:
        ...
        def tokenize_function(examples):
            if extension=='csv':
                ...
                # args=[]
                # for data1,data2 in zip(list(examples["sentence1"]),list(examples["sentence2"])):
                #     args.append((data1+' '+data2))
                # Remove empty lines
        ...
        if extension=="csv":
            rm_col=["sentence1","sentence2","label"]
        else:
            rm_col=["text"]
